...
bar1 = plt.bar(x, y0, width=width, color='#2c7bb6', label='Humid plains')
bar3 = plt.bar(x, y2, bottom=y0, width=width, color='#abd9e9', label='Humid uplands')
bar2 = plt.bar(x, y1, bottom=y0+y2, width=width, color='#d7191c', label='Arid plains')
bar4 = plt.bar(x, y3, bottom=y0+y1+y2, width=width, color='#fdae61', label='Arid uplands')
#plt.xlabel("Landform")
plt.ylabel('Percentage %')
plt.ylim([0,100])
ax = plt.gca()
