...
# prepare data
data_path = ""
slope_path = data_path + "D:/Data/DEMs/Geomorpho90m/" + "dtm_slope_merit.dem_m_250m_s0..0cm_2018_v1.0.tif"
twi_path = data_path + "D:/Data/DEMs/Geomorpho90m/" + "dtm_cti_merit.dem_m_250m_s0..0cm_2018_v1.0.tif"
elevation_path = data_path + "D:/Data/DEMs/MERIT_250m/" + "dtm_elevation_merit.dem_m_250m_s0..0cm_2017_v1.0.tif"
...
df.rename(columns={'pr_median': 'Precipitation', 'netrad_median': 'Net radiation',
                   'evap': 'Actual Evapotranspiration', 'qr': 'Recharge', 'qtot': 'Total runoff',
                   'Groundwater recharge [mm/y]': 'Recharge', 'aridity_netrad': 'Aridity'}, inplace=True)
...
g = sns.FacetGrid(df, col="dummy", palette='viridis', hue="Elevation", height=3, aspect=2)
...
g.savefig(results_path + x_name + '_' + y_name + "_scatterplot_Moeck_colored.png", dpi=600, bbox_inches='tight')
plt.close()
